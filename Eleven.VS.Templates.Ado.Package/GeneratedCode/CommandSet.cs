...
namespace Eleven.VS.Templates.Ado.Dsl
{
	...
	{
		/// <summary>
		/// Constructs a new ElevenEntityModelCommandSet.
		/// </summary>
		public ElevenEntityModelCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class ElevenEntityModelCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new ElevenEntityModelCommandSetBase.
		/// </summary>
		protected ElevenEntityModelCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewElevenEntityModelExplorerCommand,
				typeof(ElevenEntityModelEditorFactory).GUID);
		...
		{
			ElevenEntityModelExplorerToolWindow explorer = this.ElevenEntityModelExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected ElevenEntityModelDocData CurrentElevenEntityModelDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as ElevenEntityModelDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected ElevenEntityModelDocView CurrentElevenEntityModelDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as ElevenEntityModelDocView;
			}
		}
		...
		/// </summary>
		protected ElevenEntityModelExplorerToolWindow ElevenEntityModelExplorerToolWindow
		{
			get
			{
				ElevenEntityModelExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(ElevenEntityModelExplorerToolWindow), true) as ElevenEntityModelExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				ElevenEntityModelExplorerToolWindow explorerWindow = this.ElevenEntityModelExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class ElevenEntityModelClipboardCommandSet : ElevenEntityModelClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new ElevenEntityModelClipboardCommandSet.
		/// </summary>
		public ElevenEntityModelClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class ElevenEntityModelClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new ElevenEntityModelClipboardCommandSetBase.
		/// </summary>
		protected ElevenEntityModelClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
