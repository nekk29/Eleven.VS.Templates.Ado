...
namespace Eleven.VS.Templates.Ado.Dsl
{
	...
	/// </summary>
	internal partial class ElevenEntityModelDocView : ElevenEntityModelDocViewBase
	{
		/// <summary>
		/// Constructs a new ElevenEntityModelDocView.
		/// </summary>
		public ElevenEntityModelDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ElevenEntityModelDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ElevenEntityModelDocView.
		/// </summary>
		protected ElevenEntityModelDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			ElevenEntityModelDocDataBase docData = this.DocData as ElevenEntityModelDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for ElevenEntityModelDocViewBase should be an ElevenEntityModelDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ElevenEntityModelDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
