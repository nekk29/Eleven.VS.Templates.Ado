...
namespace Eleven.VS.Templates.Ado.Dsl
{
	...
	/// </summary>
	internal partial class ElevenEntityModelExplorer : ElevenEntityModelExplorerBase
	{
		/// <summary>
		/// Constructs a new ElevenEntityModelExplorer.
		/// </summary>
		public ElevenEntityModelExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the ElevenEntityModelExplorerToolWindow.
	/// </summary>
	internal abstract class ElevenEntityModelExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new ElevenEntityModelExplorerBase.
		/// </summary>
		protected ElevenEntityModelExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.ElevenEntityModelExplorerMenu;
			}
		}
		...
		{
			get { return global::Eleven.VS.Templates.Ado.Dsl.DomainEntityModel.DomainClassId; }
		}
