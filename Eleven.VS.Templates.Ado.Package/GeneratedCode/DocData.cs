...
namespace Eleven.VS.Templates.Ado.Dsl
{
	...
	/// </summary>
	internal partial class ElevenEntityModelDocData : ElevenEntityModelDocDataBase
	{
		/// <summary>
		/// Constructs a new ElevenEntityModelDocData.
		/// </summary>
		public ElevenEntityModelDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a ElevenEntityModel document in memory.
	/// </summary>
	internal abstract partial class ElevenEntityModelDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new ElevenEntityModelDocDataBase.
		/// </summary>
		protected ElevenEntityModelDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Eleven.VS.Templates.Ado.Dsl.DomainEntityModel modelRoot = null;
			...
			global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::Eleven.VS.Templates.Ado.Dsl.DomainEntityModel modelRoot = this.RootElement as global::Eleven.VS.Templates.Ado.Dsl.DomainEntityModel;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDiagram diagram = diagrams[0] as global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDiagram;
					if (diagram != null)
					{
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Eleven.VS.Templates.Ado.Dsl.DomainEntityModel modelRoot = (global::Eleven.VS.Templates.Ado.Dsl.DomainEntityModel)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
