...
namespace Eleven.VS.Templates.Ado.Dsl
{
	...
	/// </remarks>
	public partial class ElevenEntityModelToolboxHelper : ElevenEntityModelToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new ElevenEntityModelToolboxHelper.
		/// </summary>
		public ElevenEntityModelToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class ElevenEntityModelToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify ElevenEntityModel toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "ElevenEntityModel.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify EntityConnectorTool connector tool.
		/// </summary>
		public const string EntityConnectorToolFilterString = "EntityConnectorTool.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify EntityCollectionConnectorTool connector tool.
		/// </summary>
		public const string EntityCollectionConnectorToolFilterString = "EntityCollectionConnectorTool.1.0";
		...
		/// <summary>
		/// Constructs a new ElevenEntityModelToolboxHelperBase.
		/// </summary>
		protected ElevenEntityModelToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDomainModel.SingletonResourceManager.GetString("Eleven Entity ModelToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Eleven.VS.Templates.Ado.Dsl.EntityToolToolboxItem":
					// Add EntityTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Eleven.VS.Templates.Ado.Dsl.EntityToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Eleven.VS.Templates.Ado.Dsl.Eleven Entity ModelToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Eleven Entity ModelToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"EntityShapeClassF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("EntityToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Eleven.VS.Templates.Ado.Dsl.DomainEntity.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Eleven.VS.Templates.Ado.Dsl.EntityConnectorToolToolboxItem":

					// Add EntityConnectorTool connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Eleven.VS.Templates.Ado.Dsl.EntityConnectorToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("EntityConnectorToolToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("EntityConnectorToolToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.				
						"Eleven.VS.Templates.Ado.Dsl.Eleven Entity ModelToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Eleven Entity ModelToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"EntityConnectorClassF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("EntityConnectorToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						null, // Connector toolbox items do not have an underlying data object.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require), 
							new global::System.ComponentModel.ToolboxItemFilterAttribute(EntityConnectorToolFilterString)
						});
					break;
				case "Eleven.VS.Templates.Ado.Dsl.EntityCollectionConnectorToolToolboxItem":

					// Add EntityCollectionConnectorTool connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Eleven.VS.Templates.Ado.Dsl.EntityCollectionConnectorToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						3, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("EntityCollectionConnectorToolToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("EntityCollectionConnectorToolToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.				
						"Eleven.VS.Templates.Ado.Dsl.Eleven Entity ModelToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Eleven Entity ModelToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"EntityCollectionConnectorClassF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("EntityCollectionConnectorToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						null, // Connector toolbox items do not have an underlying data object.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require), 
							new global::System.ComponentModel.ToolboxItemFilterAttribute(EntityCollectionConnectorToolFilterString)
						});
					break;
				case "Eleven.VS.Templates.Ado.Dsl.EntityCollectionToolToolboxItem":
					// Add EntityCollectionTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Eleven.VS.Templates.Ado.Dsl.EntityCollectionToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Eleven.VS.Templates.Ado.Dsl.Eleven Entity ModelToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Eleven Entity ModelToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"EntityCollectionShapeClassF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("EntityCollectionToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Eleven.VS.Templates.Ado.Dsl.DomainEntityCollection.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Eleven.VS.Templates.Ado.Dsl.ElevenEntityModelDomainModel));
