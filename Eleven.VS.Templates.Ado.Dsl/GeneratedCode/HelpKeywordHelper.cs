...
namespace Eleven.VS.Templates.Ado.Dsl
{
	...
	/// </remarks>
	public partial class ElevenEntityModelHelpKeywordHelper : ElevenEntityModelHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new ElevenEntityModelHelpKeywordHelper.
		/// </summary>
		protected ElevenEntityModelHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ElevenEntityModelHelpKeywordHelper.
		/// </summary>
		public static ElevenEntityModelHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class ElevenEntityModelHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new ElevenEntityModelHelpKeywordHelperBase.
		/// </summary>
		protected ElevenEntityModelHelpKeywordHelperBase()
			: base() { }
